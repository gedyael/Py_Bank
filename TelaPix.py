...
def Janela_2():
    ...
    #Criaçao dos botoes
    Entrada_nome2= Entry(master2,borderwidth=0,font=('verdana ',12 ), justify=CENTER)
    Entrada_nome2.place(width=195, height=21, x=62, y=337)
    
    Entrada_nome3= Entry(master2,borderwidth=0,font=('verdana ',12 ), justify=CENTER)
    Entrada_nome3.place(width=192, height=16, x=64, y=417)
    master2.mainloop()
